...
参考题解：https://leetcode.cn/problems/insert-interval/solutions/472151/cha-ru-qu-jian-by-leetcode-solution/?envType=study-plan-v2&envId=top-interview-150


时间复杂度 $O(n)$，空间复杂度 $O(1)$。其中 $n$ 是区间的数量。
